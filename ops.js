var questions = {
    ...
    "epip": ["Have more trouble processing and understanding abstract concepts and/or theoretical information?","Have more trouble organizing factual information and dealing with organization in the real world?"],
    "epej": ["Have more trouble processing and understanding abstract concepts and/or theoretical information?","Have more trouble organizing factual information and dealing with organization in the real world?"],
...
function typeDesc(type512) {
    ...
    let descPartsArray = [
        ...
        "Lead play types usually live very active, busy, and/or extroverted lives. Whether or not they are genuinely happy doing so is a different matter, altogether. They generally have a tough time dealing with their inner dialogue and usually find discomforting to face.</p>",
